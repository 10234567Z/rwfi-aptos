...
export const CONTRACT_FUNCTIONS = {
  ...
  CALCULATE_TOTAL_WITHDRAWABLE: `${CONTRACT_ADDRESS}::spv::calculate_total_withdrawable_for_investor`,
  
  // Risk management functions
  ASSESS_SUPPLIER_RISK: `${CONTRACT_ADDRESS}::spv::assess_supplier_risk`,
  GET_SUPPLIER_RISK_PROFILE: `${CONTRACT_ADDRESS}::spv::get_supplier_risk_profile`,
  
  // Admin functions
  FUND_INCOME: `${CONTRACT_ADDRESS}::spv::fund_income`,
  COLLECT_INCOME: `${CONTRACT_ADDRESS}::spv::collect_income`,
  MARK_DEFAULT: `${CONTRACT_ADDRESS}::spv::mark_income_as_default`,
} as const;
